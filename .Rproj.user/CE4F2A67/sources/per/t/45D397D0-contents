...
ggarrange(fig1a, fig1b, fig1c, labels = c("1", "2", "3"), ncol = 1, font.label = list(size = 8))
...
figure_2 <-ggarrange(fig2a, fig2b, fig2c, labels = c("1", "2", "3"), nrow = 1, font.label = list(size = 9))
annotate_figure(figure_2, bottom = text_grob("0: Correct  1: Incorrect", color = "black", face = "bold", size = 10))
ggsave("Figure_2.tiff", width = 220, height = 50, units = "mm")
